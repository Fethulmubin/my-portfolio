    ...
    return (
        <div className="flex flex-col my-25 items-center justify-center h-screen bg-black">
            ...
            <img
                ...
                alt="Bulb"
                className={isBulbOn ? " bg-[#fceb55] rounded-full border-4 shadow-amber-600 shadow-2xl transition-all duration-500 size-50" : " bg-amber-50/45 rounded-full transition-all duration-500 size-50"}
            />
